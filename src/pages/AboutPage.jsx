const AboutPage = () => {
  return (
    <div className="page-container">
      ...
      <p>
        Vivekanand College stands as a beacon of knowledge and integrity, committed to delivering transformative education since its inception in <strong>[Year of Establishment, e.g., 1980]</strong>. 
        Located in the bustling heart of <strong>[City/Area, e.g., Chembur, Mumbai]</strong>, our college has consistently strived to uphold the highest standards of academic rigor and ethical values.
      </p>
      ...
      <h2>Our History</h2>
      <p>
        [Briefly describe the college's history — e.g., how it started, key milestones, growth over the years, and famous alumni if any]. 
